...
const { createProduct,menwatch,gethomeproduct,womenwatch, getproduct,getsingleproduct,addtocart ,userSelectProduct,updateproduct,deleteproduct} = require("../controller/productController");
